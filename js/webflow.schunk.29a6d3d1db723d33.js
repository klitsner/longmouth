    ...
    5487: function () {
      window.tram = (function (t) {
        ...
        var s,
          ...
          T = function (t) {
            ...
            for (e = 0; e < L.length; e++)
              if ((n = L[e] + i) in A.style) return { dom: n, css: O[e] + t };
          },
          R = (e.support = {
        ...
        var z = (e.frame =
          ...
          N = l(function (e) {
            ...
            ((e.init = function (e) {
              ...
              R.backface &&
                H.hideBackface &&
                U(this.el, R.backface.css, "hidden");
            }),
              w("add", n),
              w("start", i),
              w("wait", function (t) {
        ...
        ((e.fallback = function (t) {
          if (!R.transition) return (H.fallback = !0);
          H.agentTests.push("(" + t + ")");
      ...
      i.define(
        ...
        (t.exports = function (t, e) {
          var n,
            ...
            A = t(document);
          function L() {
            ((n = d && i.env("design")), (u = A.find(p)).each(O));
          }
          function O(e, r) {
            var a,
              u,
            ...
            (N ||
              ...
              (N.mouseLeave =
                ((u = N),
                function () {
                  ((u.hovering = !1), u.links.is(":focus") || I(u));
                })),
              (N.mouseUpOutside =
                ((l = N).mouseUpOutside && A.off(E, l.mouseUpOutside),
                c(function (e) {
                  if (l.open) {
                    var n = t(e.target);
              ...
              T(N));
            var M = N.toggle.attr("id"),
              S = N.list.attr("id");
            (M || (M = "w-dropdown-toggle-" + e),
              S || (S = "w-dropdown-list-" + e),
              N.toggle.attr("id", M),
              N.toggle.attr("aria-controls", S),
              ...
              N.list.attr("id", S),
              N.list.attr("aria-labelledby", M),
              N.links.each(function (t, e) {
                (e.hasAttribute("tabindex") || e.setAttribute("tabindex", "0"),
                  s.test(e.hash) &&
                    e.addEventListener("click", I.bind(null, N)));
              }),
              N.el.off(p),
              N.toggle.off(p),
              N.nav && N.nav.off(p));
                  ...
                  function (t) {
                    if (!n && y.open)
                      switch (
                        ...
                        case o.ESCAPE:
                          return (I(y), y.toggle.focus(), t.stopPropagation());
                        case o.ARROW_RIGHT:
                        case o.ARROW_DOWN:
                          return (
                  ...
                  function (t) {
                    if (!n) {
                      ...
                      switch (t.keyCode) {
                        case o.SPACE:
                        case o.ENTER:
                          return (O(), t.stopPropagation(), t.preventDefault());
                      }
                    }
                  }),
                ),
          ...
          function C(e) {
            if (!e.open) {
              ((r = e.el[0]),
                u.each(function (e, n) {
                  var i = t(n);
                  i.is(r) || i.has(r).length || i.triggerHandler(_);
                }),
                (e.open = !0),
                e.list.addClass(v),
                e.toggle.addClass(v),
              ...
              (n || A.on(E, e.mouseUpOutside),
                e.hovering && !o && e.el.on(x, e.mouseLeave),
                e.hovering && o && A.on(y, e.mouseMoveOutside),
                window.clearTimeout(e.delayId));
            }
          }
          function I(t, { immediate: e, forceClose: n } = {}) {
